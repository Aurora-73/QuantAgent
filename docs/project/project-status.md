...
| 项目 | 状态 | 详情 |
|------|------|------|
| **行情数据** | ✅ 正常 | baostock(优先) → AKShare(回退)，425,776 条日线，301 只股票 |
| **指数数据** | ✅ 正常 | AKShare 回退 |
| **基本面** | ✅ 已接入 | baostock 5 种报表 API，research.financials 表 604 条，301 只股票 |
| **估值** | ✅ 正常 | AKShare stock_value_em，PE/PB/市值 |
| **行业分类** | ✅ 正常 | baostock query_stock_industry，全市场映射 |
| **北向资金** | ✅ 正常 | AKShare 北向净流入 |
| **融资融券** | ✅ 正常 | AKShare |
| **新闻** | ✅ 已接入 | news/aggregator.py + AKShareCollector，events 表 116 条 |
...
| **因子存储** | ✅ 11,354,151 条 | factors 表 33 个因子，含 factor_evaluation 评估结果 |
| **回测记录** | ✅ 73 条 | backtest_runs 表，4 策略 × 多标的 |
| **决策记忆** | ✅ 9 条 | decision_memory 表，含 1/3/5/10 日回填 |
| **日报** | ✅ 31 篇 | knowledge/daily/ 目录 |
